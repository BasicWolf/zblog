...
Для реализации одного небольшого сценария нам понадобилось создать и связать четыре компонента. С каждым новым сценарием, число компонентов будет расти в арифметической
...
Не открою вам Америку, если начну с обложки этой "большой синей книги":
[TODO Evans DDD]
Эрик Эванс (Eric Evans) популяризировал термин "Domain-Driven Design" ещё в 2003м году.
А потом всё заверте... Мартин Фаулер (Martin Folwer) в своей [статье](https://martinfowler.com/bliki/DomainDrivenDesign.html) объясняет заслуги Эванса.
Эван изобрёл и закрепил терминологию DDD, которой мы пользуемся и по нынешний день.

В частности понятие об **Универсальном Языке** (Ubiquitous Language) - языке
...
Помню один удивительный и прекрасный момент озарения.
Внезапно в голове сложилась мозаика и пришло понимание,
что фундаментальные идеи DDD и Agile Manifesto имеют общие корни.

Если вы никогда не слышал о предметно-ориентированном проектировании и больше привыкли
"пилить таски из Джиры",
