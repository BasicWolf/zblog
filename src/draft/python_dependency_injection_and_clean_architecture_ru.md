...
Давайте дружно выдохнем! Больше ни одной строчки кода!
Новый сценарий пользования готов к испытаниям в продакшене.
И пока коллеги вносят последние штрихи (миграция БД, отписки
в трекере задач и т.п.) предлагаю вам короткий рассказ
о своём опыте предметно-ориентированного проектирования ака DDD.
