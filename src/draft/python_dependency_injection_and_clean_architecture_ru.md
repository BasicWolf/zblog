...
Вернёмся к нашей компонентной архитекруте. В чём её
преимущества?
...
В "Гексагональной архитекруте", гексагон в частности
призван упростить восприятие архитекруты.
...
как спроeктировать Django-приложение по канонам
...
Например ([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/main/src/myapp/application/domain/model/voting_user.py)):
...
([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/src/myapp/application/domain/model/cast_article_vote_result.py#L19)):
...
<spoiler title="Ответ">
([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/src/myapp/application/domain/model/article_vote.py))
...
([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/main/tests/test_myapp/application/domain/model/test_voting_user.py#L16)):
...
([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/main/src/myapp/application/domain/model/voting_user.py))
:
...
([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/src/myapp/application/ports/api/cast_article_vote/cast_aticle_vote_use_case.py)):
...
([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/src/myapp/application/ports/api/cast_article_vote/cast_article_vote_command.py)),
а все возможные результаты объединены - это уже знакомая модель домена
`CastArticleVoteResult` ([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/src/myapp/application/domain/model/cast_article_vote_result.py)):
...
в несколько строк ([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/src/myapp/application/adapter/api/http/article_vote_view.py)):
...
`409 CONFLICT` ([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/tests/test_myapp/application/adapter/api/http/test_article_vote_view.py)):
...
([source](https://github.com/BasicWolf/hexagonal-architecture-django/blob/568e0ab7fa3c5ec879444572a41ad5a3395bbbf8/src/myapp/application/service/post_rating_service.py)):
...
Подсказка: Что произойдёт, если при голосовании ID пользователя или публикации
...
Хотите проверить себя, насколько вы прониклись вышеизложенным?
