Framework Laptop is awesome!
############################

.. started writing on 2025-07-17
...
:status: published
:summary:
   As I am writing this text, enjoying Finnish summer from an armchair in my backyard,
   ...
   Let's go back a few years ago. It all began with a loud rant...

   .. image:: {static}img/framework-cartoon.webp
      :align: center
      :alt: Framework Laptop
      :target: {filename}framework-laptop-is-awesome.rst
...
"*Replacing a laptop screen — how hard can it be?*"

**It can be quite hard**. That's because nowadays we design electronics for
fast production, not *easy repairs*. Even when the broken component is not
...
made by kind people on Youtube.
...
That's when I promised myself: next time I buy a laptop, it's gonna be the
most repairable laptop out there. Little did I know, the Framework Laptop
had already been on the market for two years!

Imagine a laptop
================

Imagine a modern, **sustainable** laptop. It should be designed to last,
...
.. figure:: {static}img/framework-configuration.webp
   :align: center
   :alt: Framework Laptop configuration

   Configuring **your** Framework Laptop.

The experience continues as you own it.
Is your display broken? The `official manual <https://guides.frame.work/Guide/Display+Replacement+Guide/86>`_
...
Framework mainboards into desktops!

.. figure:: {static}img/case.webp
   :width: 80%
   :align: center
   :alt: Framework Laptop configuration

   Replaced an old but fully-functioning motherboard?
   Why not give it a second life as a mini PC?

Finally, imagine a laptop with full Linux support out of the box and
a great community of enthusiasts around it!
You clearly see, why Framework laptop is so appealing to me.

What I also appreciate about Framework Computers Inc. is that their
`sustainability <https://frame.work/sustainability>`_ page starts with
a big, fat, and honest **"We are not sustainable"** heading.
However, the page explains how the company aims to reduce
environmental impact by creating products that last longer.

The chassis
===========

The chassis quality is top-notch.
...
mouse - you won't get your palm fried.

The laptop is warm and rather silent for an x64 machine.
...
Watching 4K videos boosts the fan and the bottom plate gets noticeably hotter.

The 13.5'' display has 3:2 aspect ratio — that's more vertical space
...
The battery life is good for me, but there have been plenty of complaints
from the users.
...
of full-to-zero battery life — a solid result for an x64 laptop.

.. figure:: {static}img/camera-mic.webp
   :align: center
   :alt: Framework camera and microphone

   Nothing beats hardware switches when it comes to privacy!

Oh, did I mention that there is a fingerprint reader and there are hardware
switches for the microphone and the camera?


Using GNU/Linux
===============

Getting into nerdy stuff — I ditched Windows from my computer back in 2007
...
I am happy to say, that everything just works. It's been two weeks, and I
...
`Framework Laptop 13 wiki page <https://wiki.archlinux.org/title/Framework_Laptop_13>`_.
...
but all that can be fixed with proper software updates.


Shall you join the club?
========================
...
to
`this <https://guides.frame.work/Guide/Heatsink+and+Fan+Replacement+Guide/84>`__.
So, let's assume you're also not an Apple person and you want a PC.
Should you get Framework Laptop?

A pre-built Framework Laptop is more expensive than other manufacturers'
...
and about an hour to install Windows.

And if you're Linux enthusiast or an IT professional — JUST GET IT :)


My setup specs and other numbers for nerds
==========================================
...
* The CPU core temperature sensor (k10temp) showed the highest temperature
  ...
  The ACPI Thermal Zone sensors showed 35°C, 40°C and 50°C respectively.
